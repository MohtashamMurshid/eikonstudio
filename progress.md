...
- Canonical aspect ratio and resolution map to exact OpenAI `size` and `quality` values. The adapter validates those normalized fields and retains the 25 MB decoded output cap.
