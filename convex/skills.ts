...
export const createSkill = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existingSkill) {
      throw new Error(`You already have a skill named "${normalizedName}"`);
    }
...
export const updateSkill = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (skill.userId !== user._id) {
      throw new Error("Cannot update another user's skill");
    }
...
export const deleteSkill = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (skill.userId !== user._id) {
      throw new Error("Cannot delete another user's skill");
    }
