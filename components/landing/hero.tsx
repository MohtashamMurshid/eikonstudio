  ...
  return (
    <main className="pt-40 pb-20 px-6 relative">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold leading-[1.1] mb-6 tracking-tight text-black dark:text-white">
          The image studio
          <br />
          for creative AI
        </h1>
        ...
        {/* Subheadline */}
        <p className="text-base text-black/70 dark:text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link
            href="#docs"
            className="px-8 py-3.5 border border-border bg-card text-foreground font-medium rounded-lg text-sm hover:bg-accent transition-colors"
          >
            Read Docs
          </Link>
        </div>
